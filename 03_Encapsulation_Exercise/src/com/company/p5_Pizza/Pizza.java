...
public class Pizza {
    ...
    private static final String INVALID_COUNT_OF_TOPPINGS_EXCEPTION_MESSAGE = "Number of toppings should be in range [1..10].";
    ...
    public void setToppings(int countOfToppings) {
